...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('lib') }}/assets/" data-template="vertical-menu-template">
...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{ asset('lib') }}/assets/vendor/libs/@form-validation/form-validation.css" />
...
<body>
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('lib') }}/assets/vendor/libs/@form-validation/popular.js"></script>
    <script src="{{ asset('lib') }}/assets/vendor/libs/@form-validation/bootstrap5.js"></script>
    <script src="{{ asset('lib') }}/assets/vendor/libs/@form-validation/auto-focus.js"></script>
